...
export default function Homepage() {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const spices = allProducts.filter(
        (product) => product.type === "Spices Product"
      );
      const coconuts = allProducts.filter(
        (product) => product.type === "Coconut Product"
      );
                  ...
                  <div class="left">
                    ...
                    <div class="product_details">
                      ...
                      <p class="price">
                        ...
                        <span class="price_original">RS : {product.price}</span>{" "}
